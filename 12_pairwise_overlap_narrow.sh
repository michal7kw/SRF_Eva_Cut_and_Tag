...
tes_overlap_tesmut=${OVERLAP_COUNTS_1[TES_TESmut]:-0}
tesmut_overlap_tes=${OVERLAP_COUNTS_2[TES_TESmut]:-0}
tes_overlap_tead1=${OVERLAP_COUNTS_1[TES_TEAD1]:-0}
tead1_overlap_tes=${OVERLAP_COUNTS_2[TES_TEAD1]:-0}
tesmut_overlap_tead1=${OVERLAP_COUNTS_1[TESmut_TEAD1]:-0}
tead1_overlap_tesmut=${OVERLAP_COUNTS_2[TESmut_TEAD1]:-0}

# For Venn diagrams, use overlap counts (peaks that have any overlap)
tes_tesmut_overlap=${OVERLAP_COUNTS_1[TES_TESmut]:-0}
tes_tead1_overlap=${OVERLAP_COUNTS_1[TES_TEAD1]:-0}
tesmut_tead1_overlap=${OVERLAP_COUNTS_1[TESmut_TEAD1]:-0}
...
summit_tes_tesmut=${SUMMIT_OVERLAPS_1[TES_TESmut]:-0}
summit_tes_tead1=${SUMMIT_OVERLAPS_1[TES_TEAD1]:-0}
summit_tesmut_tead1=${SUMMIT_OVERLAPS_1[TESmut_TEAD1]:-0}

# Reciprocal overlaps (>=50%)
reciprocal_tes_tesmut=${RECIPROCAL_COUNTS[TES_TESmut]:-0}
reciprocal_tes_tead1=${RECIPROCAL_COUNTS[TES_TEAD1]:-0}
reciprocal_tesmut_tead1=${RECIPROCAL_COUNTS[TESmut_TEAD1]:-0}

# Jaccard indices
jaccard_tes_tesmut=${JACCARD_INDICES[TES_TESmut]:-0}
jaccard_tes_tead1=${JACCARD_INDICES[TES_TEAD1]:-0}
jaccard_tesmut_tead1=${JACCARD_INDICES[TESmut_TEAD1]:-0}
